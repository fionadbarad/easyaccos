...
export function ReceiptVerifyModal({
  ...
  return (
    <div className="fixed inset-0 bg-[rgba(0,0,0,0.72)] flex items-center justify-center z-[60] p-4">
      <div className="bg-[#1C1D20] border border-[rgba(244,245,248,0.07)] rounded-[8px] w-full max-w-[860px] max-h-[90vh] flex flex-col overflow-hidden">
        <div className="flex justify-between items-center px-5 py-4 border-b border-[rgba(244,245,248,0.07)]">
          <div>
            ...
            <h3 className="text-[#F4F5F8] text-[0.95rem] font-semibold m-0">Verify Receipt Details</h3>
          </div>
        ...
        <div className="grid grid-cols-2 flex-1 overflow-hidden min-h-0">
          <div className="border-r border-[rgba(244,245,248,0.07)] overflow-y-auto bg-[#181818] flex items-start justify-center p-4">
            {isImage ? (
              // eslint-disable-next-line @next/next/no-img-element
              <img src={scan.extract.imageUrl} alt="Receipt" className="max-w-full rounded-[4px] border border-[rgba(244,245,248,0.07)]" />
            ) : (
          ...
          <div className="overflow-y-auto p-5 flex flex-col gap-4">
            ...
            <details className="mt-auto">
              ...
              <pre className="text-[rgba(244,245,248,0.3)] text-[0.65rem] mt-2 whitespace-pre-wrap break-words font-mono max-h-[120px] overflow-y-auto bg-[#181818] border border-[rgba(244,245,248,0.07)] rounded-[4px] p-2">
        ...
        <div className="flex justify-end gap-2 px-5 py-[0.875rem] border-t border-[rgba(244,245,248,0.07)]">
          <button onClick={onCancel} className="bg-transparent text-[rgba(244,245,248,0.42)] border border-[rgba(244,245,248,0.07)] rounded-[4px] px-4 py-2 cursor-pointer text-[0.8rem]">
            Cancel
          </button>
          <button onClick={() => onConfirm(form)} className="flex items-center gap-[6px] bg-[#F4F5F8] text-[#181818] border-0 rounded-[4px] px-[18px] py-2 font-semibold cursor-pointer text-[0.8rem]">
