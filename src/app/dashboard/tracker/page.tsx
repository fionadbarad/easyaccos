...
export default function TrackerPage() {
  return (
    <div className="p-[clamp(1.5rem,4vw,2.5rem)] max-w-[960px]">
      ...
      <div className="mb-8">
        <div className="text-[rgba(244,245,248,0.18)] text-[0.6rem] uppercase tracking-[0.15em] font-mono mb-1.5">
          financial tools · 2026/27
        </div>
        <h1 className="text-[var(--sa-white)] text-[clamp(1.4rem,3vw,1.85rem)] font-semibold tracking-[-0.04em] leading-[1.1] m-0 mb-1.5">
          Tax Tracker
        </h1>
