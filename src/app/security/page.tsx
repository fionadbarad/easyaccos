      ...
      <div style={{ maxWidth: '820px', margin: '0 auto' }}>
        ...
        >
          <p style={{ color: C.text, fontSize: '1rem', lineHeight: 1.7, margin: 0 }}>
            ...
            — your financial numbers never touch our servers. All estimations run entirely in your
            browser. We only store data when you explicitly choose to save it, and only after you
        ...
        >
          ...
          <Pillar
            icon={Lock}
            title="Consent-Gated Persistence"
        ...
        >
          ...
          >
            ...
            <strong style={{ color: C.text }}>non-extractable</strong> — it cannot be read or
        ...
        <p style={{ color: C.muted, fontSize: '0.82rem', lineHeight: 1.7 }}>
          ...
          <a
            ...
            style={{
              color: C.white,
              textDecoration: 'none',
              borderBottom: '1px solid rgba(244,245,248,0.2)',
            }}
          >
