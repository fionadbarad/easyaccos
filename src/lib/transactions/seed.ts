...
export const TRANSACTIONS_SEED: Transaction[] = [
  ...
  { id: '8', date: '2026-03-05', description: 'Software Licences',            type: 'expense', amount: 54.99, reference: ''         },
  { id: '9', date: '2026-03-12', description: 'Client C — Design',            type: 'income',  amount: 1800,  reference: ''         },
]
