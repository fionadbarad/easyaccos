    ...
    return (
      <>
        <div className="flex items-center gap-[9px] mb-2">
          <div className="w-7 h-7 rounded bg-[rgba(244,245,248,0.05)] border border-[rgba(244,245,248,0.12)] shrink-0 flex items-center justify-center text-white text-[0.78rem] font-semibold font-mono">
