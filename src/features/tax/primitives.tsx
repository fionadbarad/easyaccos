...
const INP_S = 'w-full bg-[var(--sa-gray)] border border-[var(--sa-border)] rounded-[6px] px-[13px] py-[10px] text-[var(--sa-white)] text-[0.9rem] outline-none box-border min-h-[44px]'
