        ...
        {CATEGORIES.map((cat) => (
          <button
            ...
            style={{
              padding: '6px 16px',
              borderRadius: '999px',
              border: `1px solid ${category === cat ? C.white : C.border}`,
      ...
      {card ? (
        <>
          ...
          <div
            ...
            style={{
              background: C.card,
              border: `1px solid ${flipped ? 'rgba(244,245,248,0.3)' : C.border}`,
              borderRadius: '10px',
              padding: '2.5rem 2rem',
              minHeight: '220px',
              cursor: 'pointer',
          ...
          <div style={{ display: 'flex', justifyContent: 'center', gap: '1rem' }}>
            <button
              ...
              style={{
                ...
                gap: '6px',
                padding: '9px 20px',
                background: idx === 0 ? 'transparent' : 'rgba(244,245,248,0.06)',
                border: `1px solid ${idx === 0 ? C.border : C.white}`,
                borderRadius: '5px',
            ...
            <button
              ...
              style={{
                ...
                gap: '6px',
                padding: '9px 20px',
                background: idx === filtered.length - 1 ? 'transparent' : C.white,
                border: `1px solid ${idx === filtered.length - 1 ? C.border : C.white}`,
                borderRadius: '5px',
