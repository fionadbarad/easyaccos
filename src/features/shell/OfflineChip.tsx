...
export default function OfflineChip() {
  ...
  return (
    <div
      role="status"
      aria-live="polite"
      className="fixed bottom-4 right-4 z-[55] bg-sa-surface border border-sa-border rounded-full px-[14px] py-2 flex items-center gap-2 shadow-[0_6px_20px_rgba(0,0,0,0.4)]"
    >
      <WifiOff size={14} className="text-sa-white" />
      <span className="text-sa-white text-caption font-medium">
